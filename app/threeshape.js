...
export default function ShapeLearningScreen() {
  ...
  const shapes = [
    { name: "CIRCLE", letters: ["C", "I", "R", "C", "L", "E"], emoji: "⚪" },
    { name: "SQUARE", letters: ["S", "Q", "U", "A", "R", "E"], emoji: "⬛" },
    { name: "TRIANGLE", letters: ["T", "R", "I", "A", "N", "G", "L", "E"], emoji: "🔺" },
    { name: "STAR", letters: ["S", "T", "A", "R"], emoji: "⭐" },
    { name: "HEART", letters: ["H", "E", "A", "R", "T"], emoji: "❤️" },
    { name: "RECTANGLE", letters: ["R", "E", "C", "T", "A", "N", "G", "L", "E"], emoji: "▬" },
  ];
  ...
  const speakShape = () => {
    ...
    Speech.speak(shape.name, { rate: 0.9, pitch: 1.2 });

    let delay = 900;

    shape.letters.forEach((l) => {
      setTimeout(() => {
  ...
  if (finished) {
    return (
      <View style={styles.rewardContainer}>
        ...
        <Text style={styles.rewardSub}>You learned all shapes 🎉</Text>
  ...
  return (
    <Animated.View style={[styles.container, { backgroundColor: bgColor }]}>
      ...
      <Text style={styles.title}>Learn Shapes</Text>

...
export default function ThreeYearsGames() {
  ...
  const buttons = [
    { title: "Alphabets", route: "/threealphabets", color: "#FF6B6B", emoji: "🅰️" },
    { title: "Daily objects", route: "/threeobjects", color: "#4ECDC4", emoji: "🧸" },
    { title: "Habits", route: "/threehabits", color: "#FFD93D", emoji: "🪥" },
    { title: "Counting", route: "/threecount", color: "#6C5CE7", emoji: "1️⃣" },
    { title: "Shapes", route: "/threeshape", color: "#00B894", emoji: "🔷" },
    { title: "Emotions", route: "/threeemotions", color: "#FF8C42", emoji: "😊" },
  ];

  const quizButtons = [
    { title: "Alphabet Quiz", route: "/threealphaquiz", color: "#FF6B6B", emoji: "📝" },
    { title: "Color Quiz", route: "/threecolorquiz", color: "#4ECDC4", emoji: "🎨" },
    { title: "Matching", route: "/threematchquiz", color: "#FFD93D", emoji: "🧩" },
    { title: "Counting Quiz", route: "/threecountquiz", color: "#6C5CE7", emoji: "➕" },
    { title: "Shapes Quiz", route: "/threeshapequiz", color: "#00B894", emoji: "⭐" },
    { title: "Habits Quiz", route: "/threehabitsquiz", color: "#FF8C42", emoji: "🏆" },
  ];

...
export default function ThreeYearsGames() {
  ...
  const buttons = [
    { title: "Alphabets", route: "/threealphabets", color: "#FF6B6B", icon: "KEYBOARD" },
    { title: "Daily objects", route: "/threeobjects", color: "#4ECDC4", icon: "sort-numeric-asc" },
    { title: "Habits", route: "/threehabits", color: "#FFD93D", icon: "clone" },
    { title: "Counting", route: "/threecount", color: "#6C5CE7", icon: "question" },
    { title: "Shapes", route: "/threeshape", color: "#00B894", icon: "square" },
    { title: "Emotions", route: "/threeemotions", color: "#FF8C42", icon: "STAR" },
    
  ];

  // ✅ FIXED QUIZ ROUTES
  const quizButtons = [
    { title: "Alphabet Quiz", route: "/threealphaquiz", color: "#FF6B6B", icon: "star" },
    { title: "Color Quiz", route: "/threecolorquiz", color: "#4ECDC4", icon: "star" },
    { title: "Matching", route: "/threematchquiz", color: "#FFD93D", icon: "star" },
    { title: "Counting Quiz", route: "/threecountquiz", color: "#6C5CE7", icon: "star" },
    { title: "Shapes Quiz", route: "/threeshapequiz", color: "#00B894", icon: "star" },
    { title: "Habits Quiz", route: "/threehabitsquiz", color: "#FF8C42", icon: "star" },
  ];
  ...
  return (
    <Animated.View style={[styles.container, { backgroundColor: bgColor }]}>
      ...
      <Text style={styles.title}>Welcome Little Star!(3 years)</Text>

    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.bottomRow}>
          {/* Left Button */}
          <TouchableOpacity
            style={[styles.circleButton, { backgroundColor: "#FFB6C1" }]} 
            onPress={() => router.push("/TapTheCircleGame")}
          >
          ...
          {/* Right Button */}
          <TouchableOpacity
            style={[styles.circleButton, { backgroundColor: "#7FFFD4" }]} 
            onPress={() => router.push("/fourgame")}
          >
            <Text style={styles.buttonText}>Counting Game</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ImageBackground>
